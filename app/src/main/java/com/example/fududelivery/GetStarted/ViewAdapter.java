...
public class ViewAdapter extends PagerAdapter {
    ...
    private Integer[] images={R.drawable.food_delivery_restaurant_review_stars,R.drawable.shipping_truck_fast,R.drawable.group,R.drawable.streamlinehq_money_cash_bill_1____________line_48_ico_yfoicjymrxa88emm};
