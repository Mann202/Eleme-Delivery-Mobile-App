...
import static com.example.fududelivery.Customer.Address.MyAddressActivity.refreshItem;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private void setData(String name, String mobileNo, String detailAddress, Boolean selected, final int position) {
            ...
            if (MODE == SELECT_ADDRESS) {
                ...
                optionContainer.getChildAt(1).setOnClickListener(new View.OnClickListener() {  //delete address
                    @Override
                    public void onClick(View view) {
                        loadingDialog.show();
