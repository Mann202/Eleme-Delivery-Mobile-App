...
public class MyOrderUpcomingAdapter extends RecyclerView.Adapter<MyOrderViewHolder>{
    ...
    public MyOrderViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new MyOrderViewHolder(LayoutInflater.from(context).inflate(R.layout.item_customer_myorderupcoming,parent,false));
    }
